...
import categoryImage from '../images/cat4.png';
    ...
    types: [
      {
        ...
        csvFile: 'MET Ripcut End Mills.csv'
      }
    ]
  }
];
      ...
      <div className="flex gap-8">
        ...
        <div className="w-1/3">
          <div className="bg-zinc-800 rounded-2xl overflow-hidden">
            <img
              src={categoryImage}
              alt="ROUGHING ENDMILLS"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
              <h2 className="text-xl font-semibold text-white">ROUGHING ENDMILLS</h2>
              <p className="text-gray-400 mt-2">Heavy duty end mills for maximum material removal</p>
            </div>
          </div>
        </div>
