...
import categoryImage from '../images/cat5.png';
    ...
    types: [
      {
        ...
        csvFile: 'MET Single Form Thread Mills.csv'
      }
    ]
  }
];

const ThreadMills: React.FC<ComponentProps> = ({ onAddToQuote }) => {
      ...
      <div className="flex gap-8">
        ...
        <div className="w-1/3">
          <div className="bg-zinc-800 rounded-2xl overflow-hidden">
            ...
            />
            <div className="p-6">
              <h2 className="text-xl font-semibold text-white">THREAD MILLS</h2>
              <p className="text-gray-400 mt-2">Precision tools for thread milling operations</p>
            </div>
          </div>
        </div>
