...
import categoryImage from '../images/cat8.png';
    ...
    types: [
      {
        ...
        csvFile: 'MET Custom End Mills.csv'
      }
    ]
  }
];

const CustomSolutions: React.FC<ComponentProps> = ({ onAddToQuote }) => {
      ...
      <div className="flex gap-8">
        ...
        <div className="w-1/3">
          <div className="bg-zinc-800 rounded-2xl overflow-hidden">
            ...
            />
            <div className="p-6">
              <h2 className="text-xl font-semibold text-white">CUSTOM SOLUTIONS</h2>
              <p className="text-gray-400 mt-2">Customized cutting tools for specific applications</p>
            </div>
          </div>
        </div>
