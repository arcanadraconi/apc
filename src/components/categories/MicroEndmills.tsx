...
import categoryImage from '../images/cat6.png';
    ...
    types: [
      {
        ...
        csvFile: 'MET Micro Square End Mills.csv'
      }
    ]
  }
];

const MicroEndmills: React.FC<ComponentProps> = ({ onAddToQuote }) => {
      ...
      <div className="flex gap-8">
        ...
        <div className="w-1/3">
          <div className="bg-zinc-800 rounded-2xl overflow-hidden">
            ...
            />
            <div className="p-6">
              <h2 className="text-xl font-semibold text-white">MICRO ENDMILLS</h2>
              <p className="text-gray-400 mt-2">Ultra-precise tools for micro-machining applications</p>
            </div>
          </div>
        </div>
