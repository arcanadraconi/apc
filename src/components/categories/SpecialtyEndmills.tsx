...
import categoryImage from '../images/cat3.png';
    ...
    types: [
      {
        ...
        csvFile: 'MET Chamfer Mills.csv'
      }
    ]
  }
];

const SpecialtyEndmills: React.FC<ComponentProps> = ({ onAddToQuote }) => {
      ...
      <div className="flex gap-8">
        ...
        <div className="w-1/3">
          <div className="bg-zinc-800 rounded-2xl overflow-hidden">
            <img
              src={categoryImage}
              alt="SPECIALTY ENDMILLS"
              className="w-full h-64 object-cover"
            />
            <div className="p-6">
              <h2 className="text-xl font-semibold text-white">SPECIALTY ENDMILLS</h2>
              <p className="text-gray-400 mt-2">Specialized end mills for unique cutting requirements</p>
            </div>
          </div>
        </div>
...
export default SpecialtyEndmills;
